...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16.67" viewBox="0 0 640 480">
    <defs>
      <clipPath id="flagEt4x30">
        <path fill-opacity="0.7" d="M-61.3 0h682.7v512H-61.3z" />
      </clipPath>
    </defs>
    <g fill-rule="evenodd" stroke-width="1" clip-path="url(#flagEt4x30)" transform="translate(57.5)scale(.94)">
