...
// FIXME: Fix the issue with search
    ...
    <div v-else class="flex flex-col items-center">
      ...
      <div class="flex flex-col items-center">
        <div class="inline-flex mt-10 xs:mt-0">
          <a v-if="skip >= 6" :href="`/events?skip=${skip > 0 ? skip - 6 : 0}&category=${category}&text=${text}&min=${minPrice}&max=${maxPrice}`">
          ...
          <a v-if="currentPage * 6 < totalEvents && events.length >= 6" :href="`/events?skip=${skip + 6}&category=${category}&text=${text}&min=${minPrice}&max=${maxPrice}`">
